...
const tools = {
	...
	rawToData: (raw) => {
		...
		for (let o of raw ) {
			...
			let certifd2 = o[17] ? dayjs(tools.getValue(o[17])).hour(0) : certifd1
			let grn = o[1] || ""
			let sigle = o[2] || ""
			let libelle = o[3] || ""
			let convention = o[4] || ""
			...
			if (stagiaires_prevu && stagiaires_reel) description += `Stagiaires (réels/prévus) : ${stagiaires_reel}/${stagiaires_prevu}\n`
